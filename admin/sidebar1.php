...
<div class="collpase col-auto d-lg-flex d-md-none" id="SidebarCollapse">
    <div class="flex-shrink-0 col-auto min-vh-100 p-3" style="width: 280px; background-color:#222d32;">
            ...
            <li class="mb-1">
                ...
                <div class="collapse px-3" id="ManageCollapse">
                    <ul class="list-unstyled small">
                        <li>
                            <a href="index.php?p=user_manager" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">จัดการผู้ใช้ทั่วไป</a>
                        </li>
                        <li>
                            <a href="index.php?p=shop_manager" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">จัดการผู้ใช้ร้านอาหาร</a>
                        </li>
                        <li>
                            <a href="index.php?p=rider_manager" class="text-muted link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">จัดการผู้จัดส่งอาหาร</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
                <a href="index.php?p=addshop_type" class="fw-bold btn">ประเภทร้านอาหาร</a>
            </li>
