<div class="col px-3">
    <div class="container rounded-3 h-100 shadow-sm bg-white mt-3">
        <h4 class="text-center fw-bold pt-3">การจัดการผู้ใช้งานร้านอาหาร</h4>
                ...
                <div class="card shadow-s">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button class="my-3 btn btn-sm btn-outline-primary" id="btn-showShopData" data-bs-toggle="modal" data-bs-target="#modal-user" data-id="<?= $fet->user_id; ?>">ดูข้อมูลเพิ่มเติม</button>
                           <?php 
                           ...
                           ?>
                            ...
                            <?php }elseif($fet->user_status == 1) { ?>
                                <button class="btn btn-sm btn-outline-danger" id="btn-dis" data-role="<?= $fet->user_role; ?>" data-id="<?= $fet->user_id; ?>">ยกเลิกการใช้งาน</button>
