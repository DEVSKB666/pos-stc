<div class="container">
      ...
      ?>
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 col-xxl-2 my-3 text-center">
            <a href="index.php?p=product_all&type_id=<?= $fet_type->type_id; ?>&shop_id=<?= $_REQUEST['shop_id']; ?>" class="text-decoration-none text-secondary">
                <img width="90" height="90" class="rounded-circle object-fit-cover shadow" src="../img/product_type/<?= $fet_type->type_img; ?>" alt="">
    ...
    <div class="row rounded-3 bg-white shadow mt-4 px-3">
            ...
            <div class="card">
                ...
                <div class="card-body px-4">
                   ...
                   <del class="text-danger"><p class="text-center fw-bold">ราคา: <?= $fet->pro_price; ?> บาท</p></del> 
                    ...
                    <?php } ?>
                    <div class="d-grid">
                        <button id="btn-addCart" data-shop="<?= $fet->shop_id; ?>" data-id="<?= $fet->pro_id; ?>" class="btn btn-grid btn-success">นำเข้าตะกร้าสินค้า</button>
                    </div>
                </div>
        </div>
                    </div>
